  ...
  return (
    <main>
      ...
      <div onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd}
        style={{ padding: '20px 16px 8px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', position: 'relative' }}>
        {/* Left: day selector + today */}
        ...
        {/* Center: trip label */}
        <div style={{ position: 'absolute', left: '50%', transform: 'translateX(-50%)', fontSize: 11, color: 'var(--text-muted)', letterSpacing: '0.06em', pointerEvents: 'none', whiteSpace: 'nowrap' }}>
